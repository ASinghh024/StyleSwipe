-- SQL script to prevent stylists from matching with themselves
-- Run this in your Supabase SQL Editor

-- First, check if there are any self-matches
...
-- Add a check constraint to prevent future self-matches (only if it doesn't exist)
